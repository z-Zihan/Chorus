...
|------|:---:|:---:|:---:|:---:|:---:|:---:|
| 产品缺口修复 | 22 | 51h | 15 | 7 | 0 | 🔴 最高优先级 |
| v0.1 收尾 | 18 | 28.5h | 5 | 8 | 5 | ✅ 已完成 |
| v1.1 基建 | 35 | 57.5h | 11 | 20 | 4 | 🚧 进行中 |
| v0.2 开发 | 17 | 35.5h | 9 | 6 | 2 | 🔲 待开发 |
| v0.3 开发 | 13 | 27.5h | 6 | 5 | 2 | 🔲 待开发 |
| v1.0 跨用户通信 | 29 | 57h | 8 | 19 | 2 | 🔲 待开发 |
| **合计** | **134** | **257h** | **54** | **65** | **15** | |

> 产品缺口修复的 51h 是下一个发布周期的主体，其中 G0/G1/G3 先行。
> v0.1 实际耗时约 4 小时（使用 Codex + Claude Code 辅助编码）。
> v1.1 基建预估保留为工作量清单，不再按整包 57.5h 串行执行。
