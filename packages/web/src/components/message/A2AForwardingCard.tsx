...
export function A2AForwardingCard({ message, fromAgent }: Props) {
  return (
    <div
      ...
      className="message-enter ml-4 rounded-r-xl border-l-2 border-l-[var(--accent-color)] bg-[var(--bg-elevated)]/50 px-3 py-2"
    >
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <div className="text-xs font-medium text-[var(--accent-hover)]">{fromAgent.name}</div>
